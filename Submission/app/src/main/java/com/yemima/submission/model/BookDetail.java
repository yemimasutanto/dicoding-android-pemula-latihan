package com.yemima.submission.model;

import com.yemima.submission.R;
...
public class BookDetail {
    ...
    public static ArrayList<Book> getListData() {
        ...
        for (int position = 0; position < bookTitle.length; position++) {
            Book book = new Book();
            book.setName(bookTitle[position]);
            book.setDetail(bookTitle[position]);
